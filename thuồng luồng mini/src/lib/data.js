...
const BASE_PLACES = [
  ...
  },
  {
    id: 26,
    name: 'Xó Bếp Cà Phê',
    slug: 'xo-bep-ca-phe-tq',
    category: 'an-uong',
    subCategory: 'Cafe & Trà sữa',
    description: 'Quán cafe mang phong cách thời bao cấp hoài niệm, cực kỳ thư giãn.',
    fullDescription: 'Xó Bếp Cà Phê nằm tại phường Minh Xuân, nổi tiếng với không gian 3 tầng rộng rãi và cách trang trí mang đậm nét hoài cổ thời bao cấp. Những chiếc tivi cũ, bàn ghế mộc mạc và tiếng nhạc xưa cũ tạo nên một bầu không khí yên bình giữa lòng thành phố.',
    address: 'Số 2 Mạc Đĩnh Chi, Phường Minh Xuân, TP. Tuyên Quang',
    phone: '0988 555 666',
    priceRange: '$$',
    priceText: '30.000đ - 55.000đ',
    rating: 4.6,
    totalReviews: 450,
    images: ['https://images.unsplash.com/photo-1509042239860-f550ce710b93?auto=format&fit=crop&w=600&q=80', 'https://images.unsplash.com/photo-1497935586351-b67a49e012bf?auto=format&fit=crop&w=600&q=80'],
    imageColors: ['#8B4513', '#A0522D', '#CD853F'],
    openHours: 'T2-CN: 07:00 - 22:30',
    isOpen: true,
    isFeatured: true,
    isNew: true,
    tags: ['cafe', 'bao cấp', 'hoài niệm', 'yên bình', 'minh xuân'],
    amenities: ['Wifi miễn phí', 'Điều hòa', 'Góc đọc sách', 'Âm nhạc nhẹ nhàng'],
    coordinates: { lat: 21.8211, lng: 105.2162 },
    social: { facebook: 'https://facebook.com/xobepcaphe', zalo: '', instagram: '' },
    menu: [
      { name: 'Cà phê nâu lắc', price: '35.000đ' },
      { name: 'Trà sen vàng', price: '45.000đ' },
      { name: 'Bạc xỉu cốt dừa', price: '40.000đ' }
    ],
    reviews: []
  },
  {
    ...
    slug: 'quang-truong-nguyen-tat-thanh',
    category: 'du-lich',
    subCategory: 'Danh thắng',
    description: 'Biểu tượng lịch sử văn hóa của Tuyên Quang, nơi hội tụ các hoạt động cộng đồng.',
    fullDescription: 'Quảng trường Nguyễn Tất Thành rộng lớn, tọa lạc trên đường 17 tháng 8 thuộc phường Minh Xuân. Đây không chỉ là nơi đặt đền thờ Chủ tịch Hồ Chí Minh mà còn là trung tâm tổ chức các lễ hội lớn, không gian vui chơi, dạo bộ mát mẻ mỗi buổi tối của người dân địa phương.',
    address: 'Đường 17 tháng 8, Phường Minh Xuân, TP. Tuyên Quang',
    phone: '',
    priceRange: '$',
    priceText: 'Miễn phí',
    rating: 4.9,
    totalReviews: 2100,
    images: ['https://images.unsplash.com/photo-1517457373958-b7bdd4587205?auto=format&fit=crop&w=600&q=80'],
    imageColors: ['#2C3E50', '#E74C3C', '#27AE60'],
    openHours: 'Mở cửa 24/7',
    isOpen: true,
    isFeatured: true,
    isNew: false,
    tags: ['danh thắng', 'lịch sử', 'quảng trường', 'dạo bộ', 'minh xuân'],
    amenities: ['Bãi đỗ xe', 'Nhà vệ sinh công cộng', 'Khuôn viên rộng'],
    coordinates: { lat: 21.8190, lng: 105.2145 },
    social: { facebook: '', zalo: '', instagram: '' },
    menu: [],
    reviews: []
  },
  {
    id: 28,
    name: 'Đền Cảnh Xanh',
    slug: 'den-canh-xanh-tq',
    category: 'du-lich',
    subCategory: 'Di tích lịch sử',
    description: 'Ngôi đền linh thiêng với kiến trúc cổ kính tựa lưng vào núi.',
    fullDescription: 'Nằm tại phường Minh Xuân, Đền Cảnh Xanh là một điểm đến tâm linh linh thiêng thu hút rất nhiều du khách thập phương, đặc biệt vào các dịp lễ Tết. Cảnh quan xung quanh đền vô cùng hữu tình với cây cổ thụ và không khí tĩnh lặng.',
    address: 'Phường Minh Xuân, TP. Tuyên Quang',
    phone: '',
    priceRange: '$',
    priceText: 'Miễn phí',
    rating: 4.7,
    totalReviews: 890,
    images: ['https://images.unsplash.com/photo-1545562083-a600704fa486?auto=format&fit=crop&w=600&q=80'],
    imageColors: ['#2E8B57', '#006400', '#F4A460'],
    openHours: 'T2-CN: 07:00 - 18:00',
    isOpen: true,
    isFeatured: false,
    isNew: true,
    tags: ['tâm linh', 'lịch sử', 'đền chùa', 'minh xuân'],
    amenities: ['Bãi đỗ xe', 'Khu vực thắp hương'],
    coordinates: { lat: 21.8185, lng: 105.2120 },
    social: { facebook: '', zalo: '', instagram: '' },
    menu: [],
    reviews: []
  }
